...
// fully charged: 0 - 26 = 32%, partially charged: 27 - 53 = between 33% and 66% , low charge: 54 - 80 = 67% and up

function BodyQuarterly() {
  const { circleData, chartDetail } = useCircleData("body");
